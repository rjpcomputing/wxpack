...
#define FormBulder "wxFormBuilder_v2.0.69.exe"
#define Compiled "wxWidgets Compiled_v2.6.3.23.exe"
#define Additions "wxAdditions_v2.6.3.14.exe"
#define VC "wxVC_v2.6.3.44.exe"
