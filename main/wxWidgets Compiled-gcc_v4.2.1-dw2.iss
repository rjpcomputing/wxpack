...
AllowNoIcons=true
OutputBaseFilename={#MyAppName} Compiled_v{#MyAppVer}-gcc_v4.2.1-dw2
...
Name: wx\gcc; Description: MinGW Gcc v4.2.1-dw2; Flags: dontinheritcheck; Types: full gcc
